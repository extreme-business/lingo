...
const (
	...
	envKeySigningKeyAccountentication = "SIGNING_KEY_AUTHENTICATION"
...
func (c *Config) SigningKeyAccountentication() (string, error) {
	return c.configString(envKeySigningKeyAccountentication)
}
...
func (c *Config) AccountURL() (string, error) {
	return c.configString(envKeyAccountURL)
}
