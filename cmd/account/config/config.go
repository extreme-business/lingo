...
func (c *Config) DatabaseURL() (string, error) { return c.configString(envKeyDatabaseURL) }
...
func (c *Config) GRPCPort() (int, error)              { return c.configInt(envKeyGRPCPort) }
func (c *Config) GrpcTLSCertFile() (string, error)    { return c.configString(envKeyGrpcTLSCertFile) }
func (c *Config) GrpcTLSKeyFile() (string, error)     { return c.configString(envKeyGrpcTLSKeyFile) }
func (c *Config) HTTPTLSKeyFile() (string, error)     { return c.configString(envKeyHTTPTLSKeyFile) }
func (c *Config) HTTPTLSCertFile() (string, error)    { return c.configString(envKeyHTTPTLSCertFile) }
func (c *Config) AccountURL() (string, error)         { return c.configString(envKeyAccountURL) }
func (c *Config) SystemUserID() (string, error)       { return c.configString(envSystemUserID) }
func (c *Config) SystemUserEmail() (string, error)    { return c.configString(envSystemUserEmail) }
func (c *Config) SystemUserPassword() (string, error) { return c.configString(envSystemUserPassword) }
...
func (c *Config) SystemOrganizationLegalName() (string, error) {
	return c.configString(envSystemOrganizationLegalName)
}
